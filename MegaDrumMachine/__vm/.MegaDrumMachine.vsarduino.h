/* 
	...
	Hardware: Adafruit Grand Central M4 (SAMD51), Platform=samd, Package=adafruit
*/
...
#define ADAFRUIT_GRAND_CENTRAL_M4
#define __SAMD51__
#define USB_VID 0x239A
#define USB_PID 0x8031
#define USBCON
